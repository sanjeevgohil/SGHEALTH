<%@ Page Title="" Language="C#" MasterPageFile="~/doctor/dMasterPage.master" AutoEventWireup="true" CodeFile="blog.aspx.cs" Inherits="doctor_blog" %>
...
<body>
	...
	<h1 align="center">Blog Spot</h1>
		 		<br>
		<table style ="width:auto height:auto"border="0" bordercolor="white">

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label ID="Label1" runat="server" Text="Doctor Name :" font-size="28"/></font> </h2></td>
				<td style="width:50%" align="left"><asp:TextBox ID="nm" runat="server" Font-Size="14"/></td>
		</tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label ID="Label2" runat="server" Text="Blog Description :" font-size="28"/></font></h2></td>
				<td style="width:50%" align="left"><asp:TextBox ID="desc" runat="server" Font-Size="14" /></td>
		</tr>
