...
<body>
	...
	<h1 align="center">FeedBack Form</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Mobile Number :" font-size="28"/></font></h2></td>
				<td style="width:50%" align="left"><asp:TextBox ID="mno" runat="server" Font-Size="14" /></td>
		</tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Enter Feedback :" font-size="28"/></font></h2></td>
