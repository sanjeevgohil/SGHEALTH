<%@ Page Title="" Language="C#" MasterPageFile="~/patient/pMasterPage.master" AutoEventWireup="true" CodeFile="faq.aspx.cs" Inherits="patient_faq" %>
...
<body>
	...
	<h1 align="center">FAQ</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label ID="Label2" runat="server" Text="Enter Question :" font-size="28"/></font></h2></td>
