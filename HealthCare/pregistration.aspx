<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pregistration.aspx.cs" Inherits="pregistration" %>
...
<body>
	...
	<h1 align="center">Patient Registration</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Enter Name:" font-size="28"/></font> </h2></td>
				<td style="width:50%" align="left"><asp:TextBox ID="nm" runat="server" Font-Size="14" /></td>
		</tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Enter User Name:" font-size="28"/></font></h2></td>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Enter Mobile Number:" font-size="28"/></font></h2></td>
				<td style="width:50%" align="left"><asp:TextBox ID="mno" runat="server" Font-Size="14" /></td>
		</tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Enter Email:" font-size="28"/></font></h2></td>
				<td style="width:50%" align="left"><asp:TextBox ID="email" runat="server" Font-Size="14" /></td>
		</tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Select City:" font-size="28"/></font></h2></td>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#9B2509><asp:Label runat="server" Text="Select Photo:" font-size="28"/></font></h2></td>
